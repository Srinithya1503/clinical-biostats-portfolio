...
## 🎯 Career Goal & Professional Intention
...
This repository is strictly organized by functional clinical domains, moving from operational tracking and document analysis to patient metrics and biostatistical pipelines.
...
To keep my technical toolkit sharp, the `daily_practice/` subfolder logs short, focused routines addressing common real-world edge cases:
* Writing modular **SAS Macros** for efficient laboratory data conversions.
* Structuring **SQL joins** on overlapping relational clinical trial timelines.
* Testing Python statistical functions against complex baseline covariate changes.
